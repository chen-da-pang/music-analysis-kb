...
| `campaign_delivery_provenance` | Immutable KuGou canonical-delivery evidence: delivery schema/campaign IDs, source/output hashes, bytes, manifest index, contract, attempt, canonical source, and optional provenance JSON. |
